...
import net.translives.app.bean.ImageResource;
...
public class TopicActiveDetailActivity extends BaseBackActivity implements Runnable{
/*
...
*/
    ...
    public static void show(Context context, Topic topic, long id) {
        Intent intent = new Intent(context, TopicActiveDetailActivity.class);
        ...
        mDelegation.getBottomSheet().setCommitListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!AccountHelper.isLogin()) {
                    LoginActivity.show(TopicActiveDetailActivity.this);
                    return;
                }
    ...
    public void showGetDetailSuccess(TopicActive bean) {
        ...
        if (AccountHelper.isLogin() && AccountHelper.getUserId() == bean.getAuthor().getId()) {
            ...
            mTopicAppend.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    TopicCommentPublishActivity.show(TopicActiveDetailActivity.this,mBean);
                }
            });
    ...
    */
    ...
    protected boolean toShare(String title, String content, String url) {
        ...
        if (mAlertDialog == null) {
            mAlertDialog = new ShareDialog(TopicActiveDetailActivity.this)
                    .title(title)
                    .content(content)
