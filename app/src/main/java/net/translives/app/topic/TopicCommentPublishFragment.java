...
public class TopicCommentPublishFragment extends BaseFragment implements View.OnClickListener{
    ...
    private TopicActive mTopicActive;
    //private EmojiKeyboardFragment mEmojiKeyboard;

    public TopicCommentPublishFragment() {
    ...
    public void initBundle(Bundle bundle) {
        ...
        mTopicActive = (TopicActive) bundle.getSerializable("active");
    }

    @Override
    protected int getLayoutId() {
        return R.layout.fragment_topic_comment_publish;
    }
    ...
    @OnClick({ R.id.icon_back,
            R.id.icon_send, R.id.edit_content,R.id.iv_picture})// R.id.iv_mention, R.id.iv_tag,R.id.iv_emoji,
    @Override
        ...
        try {
            switch (v.getId()) {
               case R.id.iv_picture:
                   ...
                   SelectImageActivity.show(getActivity(), new SelectOptions.Builder()
                           .setHasCam(true)
                           .setSelectCount(1)
...
/*
    ...
    public void publish() {
        ...
        if (content.length() > TopicPublishFragment.MAX_TEXT_LENGTH) {
            AppContext.showToastShort(R.string.tip_content_too_long);
            return;
        }

        OSChinaApi.pubTopicComment(mTopicActive.getId(),content,0,0,0 ,new TextHttpResponseHandler() {
