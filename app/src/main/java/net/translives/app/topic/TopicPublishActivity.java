 ...
 * on 16/8/22.
 */
public class TopicPublishActivity extends BaseBackActivity {
    ...
    protected void initWidget() {
        ...
        TopicPublishFragment fragment = new TopicPublishFragment();
        // init the args bounds
        fragment.setArguments(bundle);
        FragmentTransaction trans = getSupportFragmentManager()
                .beginTransaction();
        trans.replace(R.id.activity_topic_publish, fragment);
        trans.commit();
    }
