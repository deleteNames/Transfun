...
import net.translives.app.util.PlatfromUtil;
...
public class TabMentionAdapter extends BaseGeneralRecyclerAdapter<Mention> {
    private OnUserFaceClickListener mListener;

    public TabMentionAdapter(Callback callback) {
        super(callback, ONLY_FOOTER);
        initListener();
    }

    private void initListener() {
        mListener = new TabMentionAdapter.OnUserFaceClickListener() {
            @Override
    ...
    protected RecyclerView.ViewHolder onCreateDefaultViewHolder(ViewGroup parent, int type) {
        MentionViewHolder holder = new TabMentionAdapter.MentionViewHolder(mInflater.inflate(R.layout.item_list_comment, parent, false));
