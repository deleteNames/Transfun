...
import net.translives.app.behavior.KeyboardInputDelegation;
...
import net.translives.app.user.ContactsCacheManager;
import net.translives.app.util.HTMLUtil;
import net.translives.app.util.PicturesCompressor;
import net.translives.app.util.QuickOptionDialogHelper;
 ...
 * on 2016/8/18.
 */
public class SendMessageActivity extends BaseRecyclerViewActivity<Message>
    ...
    protected void init() {
        ...
        mDelegation.showPic(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SelectImageActivity.show(SendMessageActivity.this, new SelectOptions.Builder()
                        .setHasCam(true)
                        .setSelectCount(1)
                        .setCallback(new SelectOptions.Callback() {
                            ...
                            public void doSelected(String[] images) {
                                ...
                                if (mSendQuent.containsKey(getFileName(path))) {
                                    Toast.makeText(SendMessageActivity.this, "图片已经在发送队列", Toast.LENGTH_SHORT).show();
                                } else {
        ...
        mDelegation.setSendListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(content)) {
                    Toast.makeText(SendMessageActivity.this, "请输入文字", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    protected BaseRecyclerAdapter<Message> getRecyclerAdapter() {
        return new SendMessageAdapter(this);
    }
    ...
    private class CallBack extends TextHttpResponseHandler {
        ...
        public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
            ...
            Toast.makeText(SendMessageActivity.this, "发送失败，请检查数据", Toast.LENGTH_SHORT).show();
        }
        ...
        public void onSuccess(int statusCode, Header[] headers, String responseString) {
            ...
            try {
                ...
                if (resultBean.isSuccess()) {
                    ...
                    Toast.makeText(SendMessageActivity.this, resultBean.getMessage(), Toast.LENGTH_SHORT).show();
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
