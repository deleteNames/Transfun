...
import net.translives.app.util.parser.StringParser;
import net.translives.app.widget.Loading;
...
public class SendMessageAdapter extends BaseGeneralRecyclerAdapter<Message> {
    ...
    public SendMessageAdapter(Callback callback) {
    ...
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder holder, final Message item, int position) {
        ...
        switch (getItemViewType(position)) {
            case SENDER:
                ...
                senderViewHolder.tv_sender.setText(StringParser.getInstance().parse(mContext, item.getContent()));
            ...
            case RECEIVER:
                ...
                receiverViewHolder.tv_receiver.setText(StringParser.getInstance().parse(mContext, item.getContent()));
