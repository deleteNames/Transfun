...
public class FeedBackActivity extends BaseBackActivity implements View.OnClickListener {
    ...
    private String mFeedbackStr = "[Android-%s]";
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_clear_img:
                iv_add.setImageResource(R.mipmap.ic_pic_add);
    ...
    private void addFeedBack(String content, File file) {
        getDialog("反馈中...").show();
        OSChinaApi.feedBack(AccountHelper.getUserId(), content, file, new TextHttpResponseHandler() {
            @Override
