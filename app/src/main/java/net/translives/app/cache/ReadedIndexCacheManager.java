package net.translives.app.cache;
...
public class ReadedIndexCacheManager {
    ...
    public static List<Pair<String, Integer>> getPairs(Context context) {
        if (pairs == null) {
            pairs = net.translives.app.util.CacheManager.readJson(context, FILE_NAME
     ...
     * @param type    The Article Type {@link net.translives.app.api.OSChinaApi#CATALOG_NEWS}
     *                {@link net.translives.app.api.OSChinaApi#CATALOG_BLOG}
     * @return 已读位置
     */
     ...
     * @param context Context
     * @param id      The Article Id
     * @param type    The Article Type The Article Type {@link net.translives.app.api.OSChinaApi#CATALOG_NEWS}
     *                {@link net.translives.app.api.OSChinaApi#CATALOG_BLOG}
    ...
    private static void save(final Context context, final List<Pair<String, Integer>> pairs) {
        AppOperator.getExecutor().execute(new Runnable() {
            @Override
            public void run() {
                net.translives.app.util.CacheManager.saveToJson(context, FILE_NAME, pairs);
            }
        });
    }
