 ...
 * on 16/8/26.
 */
public class DetailPicturesLayout extends ViewGroup implements View.OnClickListener {
    ...
    public DetailPicturesLayout(Context context) {
        this(context, null);
    }

    public DetailPicturesLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DetailPicturesLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs, defStyleAttr, 0);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public DetailPicturesLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs != null) {
            ...
            final TypedArray a = context.obtainStyledAttributes(
                    attrs, R.styleable.DetailPicturesLayout, defStyleAttr, defStyleRes);

            // Load clip touch corner radius
            vSpace = a.getDimensionPixelOffset(R.styleable.DetailPicturesLayout_verticalSpace, vSpace);
            hSpace = a.getDimensionPixelOffset(R.styleable.DetailPicturesLayout_horizontalSpace, hSpace);
            setColumn(a.getInt(R.styleable.DetailPicturesLayout_column, 3));
            setMaxPictureSize(a.getDimensionPixelOffset(R.styleable.DetailPicturesLayout_maxPictureSize, 0));
            a.recycle();
        }
