...
import net.translives.app.interf.OnWebViewImageListener;
import net.translives.app.media.ImageGalleryActivity;
    ...
    private static String setupWebContent(String content, boolean isShowHighlight, boolean isShowImagePreview, String css) {
        ...
        return String.format(
                "<!DOCTYPE html>"
                        + "<html>"
                        + "<head>"
                       // + (isShowHighlight ? "<link rel=\"stylesheet\" type=\"text/css\" href=\"file:///android_asset/shCore.css\">" : "")
                       // + (isShowHighlight ? "<link rel=\"stylesheet\" type=\"text/css\" href=\"file:///android_asset/shThemeDefault.css\">" : "")
