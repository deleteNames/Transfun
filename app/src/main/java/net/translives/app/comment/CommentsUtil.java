...
import net.translives.app.bean.comment.Refer;
import net.translives.app.bean.comment.Reply;
import net.translives.app.util.TDevice;
import net.translives.app.widget.MyLinkMovementMethod;
//import net.translives.app.widget.MyURLSpan;
import net.translives.app.widget.TweetTextView;
import net.translives.app.widget.drawable.shape.BorderShape;
