...
public class AnswerPublishFragment extends BaseFragment implements View.OnClickListener{
    ...
    protected void initBundle(Bundle bundle) {
        mBean = (Question) bundle.getSerializable("bean");
    }
...
/*
    ...
    public void publish() {
        ...
        if (content.length() > QuestionPublishFragment.MAX_TEXT_LENGTH) {
            AppContext.showToastShort(R.string.tip_content_too_long);
            return;
        }


        OSChinaApi.pubAnswer(mBean.getId(),content, new TextHttpResponseHandler() {
