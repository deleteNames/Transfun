...
public class QuestionPublishFragment extends BaseFragment implements View.OnClickListener{
    ...
    public QuestionPublishFragment() {
...
/*
    ...
    public void publish() {
        ...
        if (title.length() > QuestionPublishFragment.MAX_TITLE_LENGTH) {
...
*/
        ...
        OSChinaApi.pubQuestion(2,title,content, new TextHttpResponseHandler() {
