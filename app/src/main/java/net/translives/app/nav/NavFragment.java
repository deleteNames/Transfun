package net.translives.app.nav;
...
import net.translives.app.news.NewsPageFragment;
import net.translives.app.question.QuestionPageFragment;
import net.translives.app.notice.NoticeBean;
import net.translives.app.notice.NoticeManager;
import net.translives.app.user.UserInfoFragment;
...
public class NavFragment extends BaseFragment implements View.OnClickListener, NoticeManager.NoticeNotify{
    ...
    @Bind(R.id.nav_item_topic)
    NavigationButton mNavTopic;
...
/*
        ...
        */
        mNavNews.init(R.drawable.tab_icon_new,
                ...
                NewsPageFragment.class);

        mNavTopic.init(R.drawable.tab_icon_faxian,
                R.string.main_tab_name_faxian,
                TopicIndexFragment.class);

        mNavTweet.init(R.drawable.tab_icon_question,
                R.string.main_tab_name_tweet,
                QuestionPageFragment.class);
    ...
    @OnClick({R.id.nav_item_news, R.id.nav_item_topic ,R.id.nav_item_tweet,
            R.id.nav_item_explore, R.id.nav_item_me})//,R.id.nav_item_tweet_pub
    @Override
    ...
    public void onNoticeArrived(NoticeBean bean) {
        mNavExplore.showRedDot(bean.getAllCount());
    }
